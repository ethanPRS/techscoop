...
object AuthRepository {
    ...
    // Inicio de sesión con email y contraseña usando Firebase Auth (corrutina suspend).
    ...
    // Cierra sesión en Firebase y Google; borra prefs de login, sesión de usuario y Room local.
